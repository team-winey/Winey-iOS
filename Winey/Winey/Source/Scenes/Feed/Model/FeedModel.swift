...
let itemdummy = [
    ...
    FeedModel(feedId: 2, nickname: "뇽잉깅", feedTitle: "절약타이틀1아렁라ㅓ알알아러아ㅓㄹ아ㅓ라어라어ㅏ러아", feedImage: UIImage(), feedMoney: 29900, likes: 2, isLiked: false, createdAt: Date(), writerLevel: 1),
    FeedModel(feedId: 3, nickname: "뇽잉깅", feedTitle: "절약타이틀210210291021029012", feedImage: UIImage(), feedMoney: 200, likes: 2, isLiked: false, createdAt: Date(), writerLevel: 1),
    ...
    FeedModel(feedId: 6, nickname: "뇽잉깅", feedTitle: "절약타이틀52332323", feedImage: UIImage(), feedMoney: 20, likes: 2, isLiked: false, createdAt: Date(), writerLevel: 1)
    ]
